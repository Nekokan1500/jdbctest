...
public class GenericCustomerDaoImpl extends GenericBaseDao<Customer> implements CustomerDao{
    ...
    public List<Customer> getAllCustomers(Connection connection) {
        ...
        return executeQueryForList(connection, sql);
    }
    ...
    public Customer getCustomerbId(Connection connection, int id) {
        ...
        return executeQuery(connection, sql, id);
    }
